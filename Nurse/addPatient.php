...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['editid'])) {
        ...
        if ($Execute) {
            ...
            <p>At HMS, we are determined to provide you with
            excellence in healthcare services</p>
            <p>Make sure you don't share this mail publicly.Your login info: </p> 
            <p>Email Address: " . ($EmailAddress) . "</p>
            <p>Password: " . ($Password) . "</p>
            <p>Login and change your password as soon as possible</p>

            <p>P.S: You would receive mails to confirm appointment records</p>
            <p>Best Regards,<br />Hospital Management System (HMS)</p>
			";
            ...
            if (!$mail->send()) {
                ...
                $_SESSION["SuccessMessage"] = "Patient registered, Please check your mail";
                Redirect_to("addPatient.php");
            }
        }
    }
