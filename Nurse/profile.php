                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="text-center">
                                            ...
                                            while ($rs = mysqli_fetch_array($Execute)) {
                                                ...
                                                echo "
                                                <h5 class='h4'>
                                                $rs[nurseFirstname]<span class=''> $rs[nurseLastname]</span>
                                            </h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="nurseFirstname" id="nurseFirstname" value="<?php if (isset($_GET['editid'])) echo $rsedit['nurseFirstname']; ?>" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="form-control-label">Lastname</label>
                                                            <input name="nurseLastname" id="nurseLastname" value="<?php if (isset($_GET['editid'])) echo $rsedit['nurseLastname']; ?>" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
