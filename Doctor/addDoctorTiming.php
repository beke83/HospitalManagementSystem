                                        ...
                                        <form action="" method="POST">
                                            <div class="position-relative form-group">
                                                ...
                                                if (isset($_SESSION['id'])) {
                                                    echo "<input type='hidden' name='doctor' value='$_SESSION[id]' >";
                                                } else {
                                                ?>
                                                    <tr>
                                                        <td width="34%" height="36">Doctor</td>
                                                        <td width="66%"><select name="doctor" id="doctor">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = "SELECT * FROM doctor_timing_tbl where doctorid='$_SESSION[id]'";
                                                $execute = mysqli_query($db_connect, $query);
