                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="profile-info-inner">
                                    <div class="profile-img">
                                        <img src="../assets/images/user.jpg" width="100%" alt="" />
                                    </div>
                                    <div class="profile-details-hr">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr">
                                                    <p class="h5"><b>Firstname</b><br /> <?php if (isset($_GET['editid'])) echo $rsedit['firstname']; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                                    <p class="h5"><b>Lastname</b><br /> <?php if (isset($_GET['editid'])) echo $rsedit['lastname']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr">
                                                    <p class="h5"><b>Gender</b><br /> <?php if (isset($_GET['editid'])) echo $rsedit['gender']; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                                    <p class="h5"><b>BG</b><br /> <?php if (isset($_GET['editid'])) echo $rsedit['bloodGroup']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="firstname" id="firstname" disabled value="<?php if (isset($_GET['editid'])) echo $rsedit['firstname']; ?>" placeholder="Firstname" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="lastname" id="lastname" disabled value="<?php if (isset($_GET['editid'])) echo $rsedit['lastname']; ?>" placeholder="Lastname" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="address" id="address" disabled value="<?php if (isset($_GET['editid'])) echo $rsedit['address']; ?>" placeholder="Address" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="city" id="city" disabled value="<?php if (isset($_GET['editid'])) echo $rsedit['city']; ?>" placeholder="City..." type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="input-country">Country</label>
                                                            <input type="text" id="input-country" disabled class="form-control" placeholder="Country" disabled value="Nigeria">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="input-country">Phone Number</label>
                                                            <input name="phoneNumber" id="phoneNumber" disabled value="<?php if (isset($_GET['editid'])) echo $rsedit['phoneNumber']; ?>" placeholder="Phone Number" type="text" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="mb-2 form-control" id="gender" disabled value="<?php if (isset($_GET['editid'])) echo $rsedit['gender']; ?>" name="gender">
                                                                <option value="">Select gender</option>
                                                                <?php
                                                                $arr = array("Male", "Female");
                                                                foreach ($arr as $val) {
                                                                    if ($val == $rsedit['gender']) {
                                                                        echo "<option value='$val' disabled selected>$val</option>";
                                                                    } else {
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" name="dob" disabled id="dob" value="<?php if (isset($_GET['editid'])) echo $rsedit['dob']; ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="input-country">Blood Group</label>
                                                            <input type="text" name="bloodGroup" disabled id="bloodGroup" value="<?php if (isset($_GET['editid'])) echo $rsedit['bloodGroup']; ?>" class="form-control" placeholder="Blood Group" />
                                                        </div>
                                                    </div>
                                                </div>
