                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body table-responsive">
                                        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = "SELECT * FROM doctor_appointment_tbl WHERE status='Approved'";
                                                ...
                                                while ($rs = mysqli_fetch_array($execute)) {
                                                    ...
                                                    if ($rs['status'] != "Approved") {
                                                        ...
                                                        echo "<a href='patientreport.php?patientid=$rs[patientid]&appointmentid=$rs[id]'><button type='submit' class='btn btn-primary'>View Report</button></a>";
                                                    }
                                                    echo "</center></td></tr>";
                                                }
                                                ?>
