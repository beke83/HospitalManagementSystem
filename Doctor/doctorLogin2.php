...
if (isset($_POST["submit"])) {
    ...
    $DoctorCheck = mysqli_real_escape_string($db_connect, $_POST['checkDoctor']);
    $NurseCheck = mysqli_real_escape_string($db_connect, $_POST['checkNurse']);

    if(isset($_POST['checkDoctor'])&& $_POST['checkDoctor'] == 'Yes' ){
        $query = "SELECT * FROM doctor_tbl WHERE status='Active'";
        $Execute = mysqli_query($db_connect, $query);
        echo $Execute
    }
    else if
    (isset($_POST['checkNurse']) && $_POST['checkNurse'] == 'Yes'){
        echo"Nurse";
    ...
    //     Redirect_to("doctorLogin.php");
    // } else {
    //     $query = "SELECT * FROM doctor_tbl WHERE emailAddress='$_POST[emailAddress]' AND password='$_POST[password]' AND status='Active'";
    //     $Execute = mysqli_query($db_connect, $query);
                        ...
                        <div class="modal-dialog w-100 mx-auto">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="doctorLogin2.php" method="POST">
                                        <input name="checkDoctor" id="checkDoctor" type="checkbox" class="form-check-input" value="Yes">
                                        <label for="exampleCheck" class="form-check-label">Doctor</label>

                                        <input name="checkNurse" id="checkNurse" type="checkbox" class="form-check-input" value="Yes">
                                        <label for="exampleCheck" class="form-check-label">Nurse</label>
                                        <div class="form-row">
                                            <div class="col-md-12">
