...
if (isset($_POST["submit"])) {
    ...
    if (empty($emailAddress) || empty($password)) {
        ...
        $query = "SELECT * FROM patient_tbl WHERE emailAddress='$_POST[emailAddress]' AND password='$_POST[password]' AND status='Active'";
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="patientLogin.php" method="POST">
                                        ...
                                        <h6 class="mb-0">No account? <a href="patientRegister.php" class="text-primary">Sign up now</a></h6>
                                </div>
