...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['editid'])) {
        $query = "UPDATE patient_tbl SET firstname='$_POST[firstname]',lastname='$_POST[lastname]',gender='$_POST[gender]', dob='$_POST[dob]',bloodGroup='$_POST[bloodGroup]', address='$_POST[address]', city='$_POST[city]', 
         phoneNumber='$_POST[phoneNumber]',emailAddress='$_POST[emailAddress]', password='$_POST[password]',image='$_POST[Image]' WHERE id='$_GET[editid]'";
        ...
        global $db_connect;
        $query = "INSERT INTO patient_tbl(firstname,lastname,gender,dob,bloodGroup,address,city,phoneNumber,emailAddress,password,confirmPassword,image)
        VALUES('$Firstname','$Lastname', '$Gender', '$DOB', '$BloodGroup', '$Address', '$City', '$PhoneNumber', '$EmailAddress', '$Password', '$Image')";
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="pl-lg-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-control-label" for="input-address">Select Image</label>
