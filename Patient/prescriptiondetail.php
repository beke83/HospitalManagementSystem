...
<body>
	<table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
		<tbody>
			...
			<?php
			$query = "SELECT * FROM prescription WHERE patientid='$_GET[patientid]' AND appointmentid='$_GET[id]'";
	...
	?>
		...
		<table>
			<tr>
				<td>
					<button align="center"><strong>Add Prescription records</strong></button>
				</td>
			</tr>
		</table>
	<?php
