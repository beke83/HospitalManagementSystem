...
<table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
	...
	<?php
	$query = "SELECT * FROM treatment_records LEFT JOIN treatment ON treatment_records.treatmentid=treatment.id WHERE treatment_records.patientid='$_GET[patientid]' AND treatment_records.appointmentid='$_GET[id]'";
...
?>
	...
	<table>
		<tr>
			<td>
				<div align="center"><strong><a href="treatmentrecord.php?patientid=<?php echo $_GET['patientid']; ?>&appid=<?php echo $rsappointment[appointmentid]; ?>">Add Treatment records</a></strong></div>
			</td>
		</tr>
	</table>
<?php
